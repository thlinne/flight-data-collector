...
export default async function CountriesPage() {
  const countries = await apiGet<Array<{ id: string; name: string; iso3: string; enabled: boolean; priority: string }>>("/countries", []);
  return (
    <>
